...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if(empty($_POST['email']) || empty($_POST['senha'])){
        ...
        // Busca do usuário através do e-mail
        if (!$dadosDoUsuario){
            ...
            if (password_verify($senha, $dadosDoUsuario['senha'])){
                ...
                // Estando errado, mantenha o login.php
                Utils::redirecionarPara("login.php?dados_incorretos");
            }
        }
        // Se não existir usuário/usuário inválido, redirecione para o login
...
if(isset($_GET['acesso_proibido'])){
    ...
    $mensagem = "Senha ou e-mail inválido";
