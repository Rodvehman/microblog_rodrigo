<?php
    ...
    class NoticiaServico{
        ...
        public function buscarNoticias(string $valorProcurado):array {
            /* Sobre o LIKE e o operador (%)
                Ao programar buscas em campos, para que a busca não seja restritiva demais, em vez de usar coluna = valorProcurado, 
                usamos a coluna LIKE e o valor procurado.

                E para que a busca possibilite encontrar a palavra/termo em qualquer parte de uma frase/texto, aplicamos o opeador
                coringa % antes e depois do que está sendo buscado.
            */
