...
require_once "../src/Services/AutenticacaoServico.php";
	...
	// Pegar e sanitizar o id vindo de parâmetro da URL

	$id = Utils::sanitizar($_GET['id'], 'inteiro');

	// Se não houver id válido na URL faça voltar para a página de usuários
	...
	// Detectar se o formulário foi adicionado para atualizar o usuário
